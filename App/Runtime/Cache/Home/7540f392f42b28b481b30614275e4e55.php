...
<script src="/TP3.2Blog/Public/Home/style/post.js"></script>
...
<div class="meta">
	...
	<p class="meta-info">发表：<a href="/TP3.2Blog/index.php"><?php echo ($catename); ?></a> &nbsp;&nbsp; 发表日期：<?php echo (date("Y-m-d",$arts["time"])); ?> &nbsp;&nbsp; </p>
</div>

<!-- 广告代码2 -->

<div class="entry">
	<p><img class="aligncenter size-full wp-image-42806" src="/TP3.2Blog<?php echo ($arts["pic"]); ?>" width="630" height="399" sizes="(max-width: 630px) 100vw, 630px" /></p>
...
<a class="prev-post icon-right" href="/TP3.2Blog/index.php/Home/Article/index/id/<?php echo ($prevs["id"]); ?>">
...
<a class="next-post" href="/TP3.2Blog/index.php/Home/Article/index/id/<?php echo ($nexts["id"]); ?>">
