    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <li><a href="http://localhost/TP3.2Blog/" target="_blank">网站首页</a></li>
            </ul>
        </div>
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="#">管理员 : <?php echo $_SESSION['username'];?></a></li>
                <li><a href="/TP3.2Blog/index.php/Admin/Admin/logout">退出</a></li>
            </ul>
        </div>
    </div>
</div>
...
<!--/sidebar-->
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP3.2Blog/index.php/Admin/Cate/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP3.2Blog/index.php/Admin/Cate/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["catename"]); ?>" style="text-align: center"><a target="_blank" href="#" title="<?php echo ($vo["catename"]); ?>"><?php echo ($vo["catename"]); ?></a>
                            </td>

                            <td style="width: 10%">
                                <a class="link-update" href="/TP3.2Blog/index.php/Admin/Cate/updata/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('你要删除该栏目吗？');" href="/TP3.2Blog/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
