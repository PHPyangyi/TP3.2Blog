...
<!--/sidebar-->
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP3.2Blog/index.php/Admin/Admin/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP3.2Blog/index.php/Admin/Admin/add"><i class="icon-font"></i>新增管理员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td width="10%">
                                <a class="link-update" href="/TP3.2Blog/index.php/Admin/Admin/updata/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <?php if($vo['id'] != 1): ?><a class="link-del" onclick="return confirm('你要删除该管理员吗？');" href="/TP3.2Blog/index.php/Admin/Admin/del/id/<?php echo ($vo["id"]); ?>">删除</a><?php endif; ?>
