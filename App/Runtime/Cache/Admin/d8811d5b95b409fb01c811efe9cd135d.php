...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP3.2Blog/index.php/Admin/Link/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP3.2Blog/index.php/Admin/Link/add"><i class="icon-font"></i>新增链接</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td width="10%">
                                    <a class="link-update" href="/TP3.2Blog/index.php/Admin/Link/updata/id/<?php echo ($vo["id"]); ?>">修改</a>
                                    <a class="link-del" onclick="return confirm('你要删除该链接吗？');" href="/TP3.2Blog/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                </td>
